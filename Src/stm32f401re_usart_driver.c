 ...
 * @fn      		  - USART_IRQConfig
 *
 * @brief             - interrupt request configuration of that USART port
 *
...
/******************************** Configuration of CR1******************************************/
	...
	tempreg |= pUSARTHandle->USART_Config.WordLength << 12 ;
...
/******************************** Configuration of CR3******************************************/
	...
	{
		uint8_t txstate = pUSARTHandle->usart_busy;
	...
	{
		uint8_t rxstate = pUSARTHandle->usart_busy;
...
static uint16_t APB_PreScaler[4] = {2,4,8,16};
		...
		if(pUSARTHandle->TXBusyState == USART_BUSY_IN_TX)
		{
			...
			if(pUSARTHandle->TxLen > 0)
			{
				...
				if(pUSARTHandle->USART_Config.WordLength == USART_WORDLEN_9BITS)
				{
					...
					pUSARTHandle->pUSARTx->DR = (*( pUSARTHandle->pTxBuffer) & (uint16_t)0x01FF);
...
/*************************Check for IDLE detection flag ********************************************/
	...
	temp2 = pUSARTHandle->pUSARTx->CR3 & ( 1 << 4);
...
/*************************Check for Overrun detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->SR & (1<<3);
